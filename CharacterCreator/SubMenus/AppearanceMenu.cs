...
namespace CharacterCreator.SubMenus
{
    ...
    {
        private static Menu _appearanceMenu;

        public static void SetupMenu(bool male, bool editPed)
        {
            _appearanceMenu.ClearMenuItems();
            ...
            */
            ...
            // hair
            int currentHairStyle = editPed ? MainMenu.currentCharacter.PedAppearance.hairStyle : GetPedDrawableVariation(Game.PlayerPed.Handle, 2);
            int currentHairColor = editPed ? MainMenu.currentCharacter.PedAppearance.hairColor : 0;
            int currentHairHighlightColor = editPed ? MainMenu.currentCharacter.PedAppearance.hairHighlightColor : 0;

            // 0 blemishes
            int currentBlemishesStyle = editPed ? MainMenu.currentCharacter.PedAppearance.blemishesStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 0) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 0) : 0;
            float currentBlemishesOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.blemishesOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 0, currentBlemishesStyle, currentBlemishesOpacity);

            // 1 beard
            int currentBeardStyle = editPed ? MainMenu.currentCharacter.PedAppearance.beardStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 1) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 1) : 0;
            float currentBeardOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.beardOpacity : 0f;
            int currentBeardColor = editPed ? MainMenu.currentCharacter.PedAppearance.beardColor : 0;
            ...
            // 2 eyebrows
            int currentEyebrowStyle = editPed ? MainMenu.currentCharacter.PedAppearance.eyebrowsStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 2) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 2) : 0;
            float currentEyebrowOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.eyebrowsOpacity : 0f;
            int currentEyebrowColor = editPed ? MainMenu.currentCharacter.PedAppearance.eyebrowsColor : 0;
            ...
            // 3 ageing
            int currentAgeingStyle = editPed ? MainMenu.currentCharacter.PedAppearance.ageingStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 3) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 3) : 0;
            float currentAgeingOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.ageingOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 3, currentAgeingStyle, currentAgeingOpacity);

            // 4 makeup
            int currentMakeupStyle = editPed ? MainMenu.currentCharacter.PedAppearance.makeupStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 4) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 4) : 0;
            float currentMakeupOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.makeupOpacity : 0f;
            int currentMakeupColor = editPed ? MainMenu.currentCharacter.PedAppearance.makeupColor : 0;
            ...
            // 5 blush
            int currentBlushStyle = editPed ? MainMenu.currentCharacter.PedAppearance.blushStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 5) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 5) : 0;
            float currentBlushOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.blushOpacity : 0f;
            int currentBlushColor = editPed ? MainMenu.currentCharacter.PedAppearance.blushColor : 0;
            ...
            // 6 complexion
            int currentComplexionStyle = editPed ? MainMenu.currentCharacter.PedAppearance.complexionStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 6) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 6) : 0;
            float currentComplexionOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.complexionOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 6, currentComplexionStyle, currentComplexionOpacity);

            // 7 sun damage
            int currentSunDamageStyle = editPed ? MainMenu.currentCharacter.PedAppearance.sunDamageStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 7) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 7) : 0;
            float currentSunDamageOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.sunDamageOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 7, currentSunDamageStyle, currentSunDamageOpacity);

            // 8 lipstick
            int currentLipstickStyle = editPed ? MainMenu.currentCharacter.PedAppearance.lipstickStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 8) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 8) : 0;
            float currentLipstickOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.lipstickOpacity : 0f;
            int currentLipstickColor = editPed ? MainMenu.currentCharacter.PedAppearance.lipstickColor : 0;
            ...
            // 9 moles/freckles
            int currentMolesFrecklesStyle = editPed ? MainMenu.currentCharacter.PedAppearance.molesFrecklesStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 9) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 9) : 0;
            float currentMolesFrecklesOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.molesFrecklesOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 9, currentMolesFrecklesStyle, currentMolesFrecklesOpacity);

            // 10 chest hair
            int currentChesthairStyle = editPed ? MainMenu.currentCharacter.PedAppearance.chestHairStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 10) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 10) : 0;
            float currentChesthairOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.chestHairOpacity : 0f;
            int currentChesthairColor = editPed ? MainMenu.currentCharacter.PedAppearance.chestHairColor : 0;
            ...
            // 11 body blemishes
            int currentBodyBlemishesStyle = editPed ? MainMenu.currentCharacter.PedAppearance.bodyBlemishesStyle : GetPedHeadOverlayValue(Game.PlayerPed.Handle, 11) != 255 ? GetPedHeadOverlayValue(Game.PlayerPed.Handle, 11) : 0;
            float currentBodyBlemishesOpacity = editPed ? MainMenu.currentCharacter.PedAppearance.bodyBlemishesOpacity : 0f;
            SetPedHeadOverlay(Game.PlayerPed.Handle, 11, currentBodyBlemishesStyle, currentBodyBlemishesOpacity);

            int currentEyeColor = editPed ? MainMenu.currentCharacter.PedAppearance.eyeColor : 0;
            ...
            _appearanceMenu.AddMenuItem(hairStyles);
            _appearanceMenu.AddMenuItem(hairColors);
            _appearanceMenu.AddMenuItem(hairHighlightColors);

            _appearanceMenu.AddMenuItem(blemishesStyle);
            _appearanceMenu.AddMenuItem(blemishesOpacity);

            _appearanceMenu.AddMenuItem(beardStyles);
            _appearanceMenu.AddMenuItem(beardOpacity);
            _appearanceMenu.AddMenuItem(beardColor);

            _appearanceMenu.AddMenuItem(eyebrowStyle);
            _appearanceMenu.AddMenuItem(eyebrowOpacity);
            _appearanceMenu.AddMenuItem(eyebrowColor);

            _appearanceMenu.AddMenuItem(ageingStyle);
            _appearanceMenu.AddMenuItem(ageingOpacity);

            _appearanceMenu.AddMenuItem(makeupStyle);
            _appearanceMenu.AddMenuItem(makeupOpacity);
            _appearanceMenu.AddMenuItem(makeupColor);

            _appearanceMenu.AddMenuItem(blushStyle);
            _appearanceMenu.AddMenuItem(blushOpacity);
            _appearanceMenu.AddMenuItem(blushColor);

            _appearanceMenu.AddMenuItem(complexionStyle);
            _appearanceMenu.AddMenuItem(complexionOpacity);

            _appearanceMenu.AddMenuItem(sunDamageStyle);
            _appearanceMenu.AddMenuItem(sunDamageOpacity);

            _appearanceMenu.AddMenuItem(lipstickStyle);
            _appearanceMenu.AddMenuItem(lipstickOpacity);
            _appearanceMenu.AddMenuItem(lipstickColor);

            _appearanceMenu.AddMenuItem(molesFrecklesStyle);
            _appearanceMenu.AddMenuItem(molesFrecklesOpacity);

            _appearanceMenu.AddMenuItem(chestHairStyle);
            _appearanceMenu.AddMenuItem(chestHairOpacity);
            _appearanceMenu.AddMenuItem(chestHairColor);

            _appearanceMenu.AddMenuItem(bodyBlemishesStyle);
            _appearanceMenu.AddMenuItem(bodyBlemishesOpacity);

            _appearanceMenu.AddMenuItem(eyeColor);
        ...
        {
            _appearanceMenu = new Menu("Character Appearance", "Character appearance options.");
            ...
            _appearanceMenu.OnListIndexChange += (_menu, listItem, oldSelectionIndex, newSelectionIndex, itemIndex) =>
            {
                if (itemIndex == 0) // hair style
                {
                    ClearPedFacialDecorations(Game.PlayerPed.Handle);
                    MainMenu.currentCharacter.PedAppearance.HairOverlay = new KeyValuePair<string, string>("", "");
                    ...
                    if (newSelectionIndex >= GetNumberOfPedDrawableVariations(Game.PlayerPed.Handle, 2))
                    {
                        ...
                        MainMenu.currentCharacter.PedAppearance.hairStyle = 0;
                    }
                    else
                    {
                        SetPedComponentVariation(Game.PlayerPed.Handle, 2, newSelectionIndex, 0, 0);
                        MainMenu.currentCharacter.PedAppearance.hairStyle = newSelectionIndex;
                        if (hairOverlays.ContainsKey(newSelectionIndex))
                        {
                            ...
                            MainMenu.currentCharacter.PedAppearance.HairOverlay = new KeyValuePair<string, string>(hairOverlays[newSelectionIndex].Key, hairOverlays[newSelectionIndex].Value);
                        }
                    }
                }
                else if (itemIndex == 1 || itemIndex == 2) // hair colors
                {
                    ...
                    MainMenu.currentCharacter.PedAppearance.hairColor = hairColor;
                    MainMenu.currentCharacter.PedAppearance.hairHighlightColor = hairHighlightColor;
                }
                else if (itemIndex == 33) // eye color
                {
                    ...
                    MainMenu.currentCharacter.PedAppearance.eyeColor = selection;
                }
                else
                {
                    int selection = ((MenuListItem)_menu.GetMenuItems()[itemIndex]).ListIndex;
                    ...
                    switch (itemIndex)
                    {
                        case 3: // blemishes
                            ...
                            MainMenu.currentCharacter.PedAppearance.blemishesStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.blemishesOpacity = opacity;
                            break;
                        case 5: // beards
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 1, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.beardStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.beardOpacity = opacity;
                            break;
                        case 7: // beards color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 1, 1, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.beardColor = selection;
                            break;
                        case 8: // eyebrows
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 2, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.eyebrowsStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.eyebrowsOpacity = opacity;
                            break;
                        case 10: // eyebrows color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 2, 1, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.eyebrowsColor = selection;
                            break;
                        case 11: // ageing
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 3, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.ageingStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.ageingOpacity = opacity;
                            break;
                        case 13: // makeup
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 4, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.makeupStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.makeupOpacity = opacity;
                            break;
                        case 15: // makeup color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 4, 2, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.makeupColor = selection;
                            break;
                        case 16: // blush style
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 5, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.blushStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.blushOpacity = opacity;
                            break;
                        case 18: // blush color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 5, 2, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.blushColor = selection;
                            break;
                        case 19: // complexion
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 6, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.complexionStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.complexionOpacity = opacity;
                            break;
                        case 21: // sun damage
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 7, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.sunDamageStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.sunDamageOpacity = opacity;
                            break;
                        case 23: // lipstick
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 8, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.lipstickStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.lipstickOpacity = opacity;
                            break;
                        case 25: // lipstick color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 8, 2, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.lipstickColor = selection;
                            break;
                        case 26: // moles and freckles
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 9, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.molesFrecklesStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.molesFrecklesOpacity = opacity;
                            break;
                        case 28: // chest hair
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 10, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.chestHairStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.chestHairOpacity = opacity;
                            break;
                        case 30: // chest hair color
                            SetPedHeadOverlayColor(Game.PlayerPed.Handle, 10, 1, selection, selection);
                            MainMenu.currentCharacter.PedAppearance.chestHairColor = selection;
                            break;
                        case 31: // body blemishes
                            SetPedHeadOverlay(Game.PlayerPed.Handle, 11, selection, opacity);
                            MainMenu.currentCharacter.PedAppearance.bodyBlemishesStyle = selection;
                            MainMenu.currentCharacter.PedAppearance.bodyBlemishesOpacity = opacity;
                            break;
                    }
                }
            };
        ...
        public Menu GetMenu()
        {
            if (_appearanceMenu == null)
            {
                CreateMenu();
            }
            return _appearanceMenu;
        }
    }
}